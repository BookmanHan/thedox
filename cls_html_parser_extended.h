...
class cls_html_parser_extended
...
public:
		...
		case 2:
			{
				...
				new_node->context = now[2].str_pre;
	...
	cls_html_parser_extended()
	{
		...
		v_product.push_back("#tuple_start#@#tuple_list#");
		v_product.push_back("#tuple#@$<$$var$#attribute_list#$/$$>$");
		v_product.push_back("#attribute#@$var$$=$$\"$$num$$\"$");
		v_product.push_back("#attribute#@$var$$=$$\'$$num$$\'$");
		v_product.push_back("#tuple_list#@#tuple_list#$num$");
		v_product.push_back("#tuple_list#@$var$$<$$var$");
		v_product.push_back("#tuple_list#@$var$$>$$var$");
		v_product.push_back("")
